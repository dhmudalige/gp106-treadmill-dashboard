...
"}")
        self.progressBar.setProperty(u"value", 24)
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>TREADMILL</strong> DASHBOARD", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: GROUP 076", None))
    # retranslateUi
